...
const Alert = ({ type = 'info', message, className = '', onClose }) => {
  ...
  return (
    <div className={`border-l-4 p-4 ${bg} ${border} ${text} rounded-md ${className}`}>
      <div className="flex">
        ...
        {onClose && (
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                className={`inline-flex rounded-md p-1.5 ${text} hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-${bg} focus:ring-${border}`}
                onClick={onClose}
              >
